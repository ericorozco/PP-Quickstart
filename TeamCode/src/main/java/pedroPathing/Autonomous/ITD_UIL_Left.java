...
public class ITD_UIL_Left extends OpMode {
    ...
    public static double samplePos1X = 20.2;
    public static double samplepos1Y = 125.2;
...
//                    OuttakeElbowRight.setPosition(OuttakeElbowPositionSpecimenScoring);
            ...
            case 11:
            ///Aim to score
                if (pathTimer.getElapsedTimeSeconds() >= 2.75 && !follower.isBusy()) {
            ...
            case 28:
                ...
                break;
            case 29:
                if (pathTimer.getElapsedTimeSeconds() >= 2.25 && !follower.isBusy()) {
                    OuttakeWrist.setPosition(OuttakeWristPositionScoring);
                    setPathState(30);
                }
                break;
