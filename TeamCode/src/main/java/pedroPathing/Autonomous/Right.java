...
public class Right extends OpMode {
    ...
    final double IntakeSliderPositionIN = 0.60;
    final double IntakeSliderPositionOUT = 0.0;
    ...
    private final Pose scorePose = new Pose(25, 62, Math.toRadians(180));

    /** Lowest (First) Sample from the Spike Mark */
    private final Pose samplepos1 = new Pose(62, 24, Math.toRadians(0));
    private final Pose controlsamplepos1 = new Pose(2, 24, Math.toRadians(0));
    private final Pose controlsamplepos12 = new Pose(83, 42, Math.toRadians(0));
    private final Pose samplepush1 = new Pose(25, 24, Math.toRadians(0));
    private final Pose controlsamplepush1 = new Pose(44, 17, Math.toRadians(0));
    ...
    private PathChain sample1, sample2, recoger, recogerFromScore, score;
    public void sliderMove (int Position){
        OuttakeSliderLeft.setTargetPosition(Position);
        OuttakeSliderRight.setTargetPosition(Position);
        ...
        switch (pathState) {
            ...
            case 3:
                ...
                if(!follower.isBusy()) {
                    ...
                    /* Since this is a pathChain, we can have Pedro hold the end point while we are grabbing the sample */
                    follower.followPath(recoger,true);
                    sleep(1000);
                    setPathState(4);
                }
                break;
    ...
    public void init() {
        ...
        initialPos = (initialPositionLeft + initialPositionRight)/2;
